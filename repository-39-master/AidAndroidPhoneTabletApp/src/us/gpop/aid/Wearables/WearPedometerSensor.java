 ...
 */
public class WearPedometerSensor implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        switch (event.sensor.getType()) {
            ...
            case Sensor.TYPE_STEP_DETECTOR: // CHANGE TARGET TO 4.4.2 FOR SUPPORT

                totalSteps = totalSteps + 1; // Increments the steps.
                break;

            case Sensor.TYPE_STEP_COUNTER: // CHANGE TARGET TO 4.4.2 FOR SUPPORT
    ...
    public void setUpSensors(Context con) {
        ...
        mStepCounterSensor = sensorManager.getDefaultSensor(Sensor.TYPE_STEP_COUNTER); // CHANGE TARGET TO 4.4.2 FOR SUPPORT
        mStepDetectorSensor = sensorManager.getDefaultSensor(Sensor.TYPE_STEP_DETECTOR); // CHANGE TARGET TO 4.4.2 FOR SUPPORT
    }
    ...
    public void getSensorData() {
        ...
        Sensor countSensor = sensorManager.getDefaultSensor(Sensor.TYPE_STEP_COUNTER); // CHANGE TARGET TO 4.4.2 FOR SUPPORT
